...
export const ACTION_LABELS = {
  ...
  legalUnderReview: 'Under Review',
  legalPendingInternal: 'Pending Internal',
  legalPendingExternal: 'Pending External',
  legalOfflineExecution: 'Offline Execution',
  legalOnHold: 'On Hold',
  legalCompleted: 'Completed',
