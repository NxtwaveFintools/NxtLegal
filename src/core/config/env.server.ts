...
export const envServer = {
  ...
  zohoSignOauthBaseUrl: optionalEnv('ZOHO_SIGN_OAUTH_BASE_URL'),
  zohoSignClientId: optionalEnv('ZOHO_SIGN_CLIENT_ID'),
  zohoSignClientSecret: optionalEnv('ZOHO_SIGN_CLIENT_SECRET'),
  zohoSignRefreshToken: optionalEnv('ZOHO_SIGN_REFRESH_TOKEN'),
