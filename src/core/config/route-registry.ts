...
export const routeRegistry = {
  ...
  api: {
    ...
    contracts: {
      ...
      uploadInit: '/api/contracts/upload/init',
      uploadFinalize: '/api/contracts/upload/finalize',
      detail: '/api/contracts/:contractId',
      replaceMainDocument: '/api/contracts/:contractId/replace-main-document',
      replaceMainDocumentInit: '/api/contracts/:contractId/replace-main-document/init',
      replaceMainDocumentFinalize: '/api/contracts/:contractId/replace-main-document/finalize',
      ...
      renameTitle: '/api/contracts/:contractId/title',
      ...
      finalSignedArtifactPreview: '/api/contracts/:contractId/signed-docs/final/preview',
