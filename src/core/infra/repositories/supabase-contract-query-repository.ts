...
const actionLabelMap: Record<ContractActionName, string> = {
  ...
  'legal.set.under_review': 'Under Review',
  'legal.set.pending_internal': 'Pending Internal',
  'legal.set.pending_external': 'Pending External',
  'legal.set.offline_execution': 'Offline Execution',
  'legal.set.on_hold': 'On Hold',
  'legal.set.completed': 'Completed',
