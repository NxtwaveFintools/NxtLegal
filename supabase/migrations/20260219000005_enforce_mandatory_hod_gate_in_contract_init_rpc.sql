-- Enforce mandatory HOD gate for all contract uploads
-- All uploads must initialize in HOD_PENDING and route to a valid HOD assignee
...
BEGIN
	...
	-- Mandatory HOD gate for all uploads
