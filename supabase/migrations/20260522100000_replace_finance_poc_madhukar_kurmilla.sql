...
-- Old POC : Satti Suresh Reddy    (satti.sureshreddy@nxtwave.co.in)
-- New POC : Madhukar Kurmilla     (kurmilla.madhukar@nxtwave.co.in)
-- Date    : 2026-05-22
...
DECLARE
  v_tenant_id     uuid;
  v_team_id       uuid;
  v_old_poc_email text := 'satti.sureshreddy@nxtwave.co.in';
  v_new_poc_email text := 'kurmilla.madhukar@nxtwave.co.in';
  v_new_poc_name  text := 'Madhukar Kurmilla';
  v_employee_id   text := 'NW0001560';
