-- ============================================================
-- Migration: Add Launchpad department with POC and HOD
-- Team     : Launchpad
-- POC      : Shreshth Kumar Jaiswal (shreshth.kumarjaiswal@nxtwave.co.in)
-- HOD      : Srikar E (srikar@nxtwave.tech)
...
DECLARE
  v_tenant_id  uuid;
  v_team_id    uuid;
  v_poc_email  text := 'shreshth.kumarjaiswal@nxtwave.co.in';
  v_hod_email  text := 'srikar@nxtwave.tech';
  v_poc_name   text := 'Shreshth Kumar Jaiswal';
  v_hod_name   text := 'Srikar E';
  v_team_name  text := 'Launchpad';
BEGIN
...
WHERE u.email IN (
  'shreshth.kumarjaiswal@nxtwave.co.in',
  'srikar@nxtwave.tech'
)
ORDER BY u.role;
